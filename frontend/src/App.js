    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="OnboardingApplication/NeverSubmitted/:userName"
            element={<OnboardingApplicationNeverSubmitted />}
          />
          <Route
            path="OnboardingApplication/Pending/:userName"
            element={<OnboardingApplicationPending />}
          />
          <Route
            path="OnboardingApplication/Rejected/:userName"
            element={<OnboardingApplicationRejected />}
          />
          <Route path="HiringManagement" element={<HiringManagement />} />
          <Route
            path="SingleApplicationView/:applicationId"
